...
<%@include file="/libs/foundation/global.jsp"%><%
    ...
    if (hasImage) {
        %><%= "path: " + listItem.getPath() %><img class="teaser" src="<%= listItem.getPath() %>/jcr:content.thumbnail.48.48.jpg" alt="<%= xssAPI.encodeForHTMLAttr(title) %>" title="<%= xssAPI.encodeForHTMLAttr(title) %>"><%
    }
